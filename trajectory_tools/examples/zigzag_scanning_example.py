...
def robot_program():
    ...
    th.sequencer.plan(Ptp(goal=pose0, vel_scale=0.2, acc_scale=0.3))
    th.sequencer.execute()
    ...
    th.sequencer.execute()
    th.sequencer.plan(Ptp(goal=pose2, vel_scale=0.1, acc_scale=0.3))
    th.sequencer.execute()
    th.sequencer.plan(Ptp(goal=pose3, vel_scale=0.1, acc_scale=0.3))
    th.sequencer.execute()
    th.sequencer.plan(Ptp(goal=pose4, vel_scale=0.1, acc_scale=0.3))
    th.sequencer.execute()
    th.sequencer.plan(Ptp(goal=pose5, vel_scale=0.1, acc_scale=0.3))
    th.sequencer.execute()
    th.sequencer.plan(Ptp(goal=pose6, vel_scale=0.1, acc_scale=0.3))
    th.sequencer.execute()
    th.sequencer.plan(Ptp(goal=pose7, vel_scale=0.1, acc_scale=0.3))
    th.sequencer.execute()
    th.sequencer.plan(Ptp(goal=pose8, vel_scale=0.1, acc_scale=0.3))
    th.sequencer.execute()
    th.sequencer.plan(Ptp(goal=pose9, vel_scale=0.1, acc_scale=0.3))
    th.sequencer.execute()
    th.sequencer.plan(Ptp(goal=pose10, vel_scale=0.1, acc_scale=0.3))
    th.sequencer.execute()
    th.sequencer.plan(Ptp(goal=pose11, vel_scale=0.1, acc_scale=0.3))
    th.sequencer.execute()
    th.sequencer.plan(Ptp(goal=pose12, vel_scale=0.1, acc_scale=0.3))
    th.sequencer.execute()
    th.sequencer.plan(Ptp(goal=pose13, vel_scale=0.1, acc_scale=0.3))
    th.sequencer.execute()
